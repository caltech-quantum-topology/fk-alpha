/**
 * @file linalg64.hpp
 * @brief Linear algebra operations for matrix-polynomial computations in Gukov-Manolescu invariants (uint64_t version)
 * 
 ...
 */
int64_t dot(const std::vector<int>& a, const std::vector<int>& b) {
    int64_t acc = a[0];  // Start with constant term
 ...
 */
void matrix_index_column_recurse(int& dim, std::vector<int> lengths, int& slice, int value, int acc, int index, std::vector<bilvector<int64_t>>& term, int r, int& z, int sign, std::vector<int> blocks) {
    index++;
    int old_acc = acc;
 ...
 */
void matrix_index_column(int& dim, std::vector<int> lengths, int& slice, int value, std::vector<bilvector<int64_t>>& term, int r, int& z, int sign, std::vector<int> blocks) {
    if (slice == 0) {
 ...
 */
void offset_addition_recurse (std::vector<bilvector<int64_t>>& a, std::vector<bilvector<int64_t>>& b, std::vector<int>& offsets, int bilvector_offset, int& dim, std::vector<int> lengths, int index, int acc, int acc2, int sign, std::vector<int> a_blocks, std::vector<int> b_blocks) {
    index++;
    int old_acc = acc;
 ...
 */
void offset_addition(std::vector<bilvector<int64_t>>& a, std::vector<bilvector<int64_t>> b, std::vector<int>& offsets, int bilvector_offset, int& dim, std::vector<int> lengths, int sign, std::vector<int> a_blocks, std::vector<int> b_blocks) {
